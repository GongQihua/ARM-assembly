@ Opens the /dev/mem device and maps System Timer memory
@ as well as GPIO
...
@ ======================================
@ =====  Here is your Timer Macro  =====
@ ======================================
.macro Timer reg, time
@ ***DO NOT use R10 in this macro
...
@ can access them        
        ...
        mov     r3, MAP_SHARED  @ share with other processes
        bl      mmap
        mov     r6, r0          @ save virtual memory address        
